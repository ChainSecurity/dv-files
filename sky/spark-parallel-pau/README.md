...
We have checked the concern that the facet wiring could be circumvented to execute arbitrary `delegatecall`s, and we found that no such path exists. The reasoning is below.
